...
import { uploadResumeController, getBackendValueController, submitRouteController } from "../controllers/data-control.js";
...
router.post(CONFIG.submitRoute, requireAuth, submitRouteController);
